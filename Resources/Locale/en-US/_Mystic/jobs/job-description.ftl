...
job-description-divinologist = Study the divine, appease them, or enrage them, and use the residual energy to help the station
job-description-fledgling = Learn the basics of Arcaneology
job-description-sl = Manage the service department, ensure they aren't making a mess, and keep Ian safe.
